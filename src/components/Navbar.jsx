  ...
  return (
    <div className="w-full py-5 px-4 md:p-0 md:w-fit">
      <nav className="flex justify-between z-10 bg-white lg:justify-evenly h-fit items-center w-full pt-1 lg:py-10">
        <Link to="/">
          <h1 className="logo md:hidden font-planet text-secondary text-2xl">
            xander
          </h1>
        </Link>
        <ul
          className={`border-2 md:flex w-full flex-col justify-between md:justify-start fixed top-0 md:left-0 transition-all  z-50 md:z-0  md:w-64 h-screen bg-primary border-accent ${
            !menuIsOpen ? "left-[-100%]" : "left-0"
          }`}
        >
          <Link to="/">
            <h1 className="logo font-planet py-2 pt-8 px-5 text-accent text-2xl md:text-3xl ">
              xander
            </h1>
          </Link>
          ...
          <div className="list-container py-3">
            ...
            <div className=" flex justify-evenly items-center">
              <li className="w-fit lg:w-fit py-2 px-5 hover:bg-blue-700 lg:px-3 xl:px-4 text-secondary text-xl  lg:text-black no-underline bg-transparent font-patino capitalize">
                <a href="https://youtube.com/@xander.thegr8?si=GizhtR5ha-3f8Wuc">
                  youtube
                </a>
              </li>
              <span className=" w-full pr-5 flex items-center justify-evenly gap-2">
            ...
            <div className=" flex justify-evenly items-center">
              <li className="w-fit lg:w-fit py-2 px-5 hover:bg-blue-700 lg:px-3 xl:px-4 text-secondary text-xl  lg:text-black no-underline bg-transparent font-patino capitalize">
              <a href="https://open.spotify.com/show/7uPnmTg0EQRSpd6ANJuXFv?si=4f6409aa16514f53">
                  podcast
                </a>
              </li>
              <span className=" w-full pr-5 flex items-center justify-evenly gap-2">
        ...
        <div
          className="background fixed bg-primary right-5 top-4 z-[100] md:hidden"
          onClick={toggleMenu}
        >
          <button className="menu__icon">
            <span
              className={`w-full h-[2px] rounded-2xl border-black bg-black block transition-all ${
                !menuIsOpen ? "" : "menu_span1"
              }`}
            ></span>
            <span
              className={`w-full h-[2px] rounded-2xl border-black bg-black block transition-all ${
                !menuIsOpen ? "" : "menu_span2"
              }`}
            ></span>
            <span
              className={`w-full h-[2px] rounded-2xl border-black bg-black block transition-all ${
                !menuIsOpen ? "" : "menu_span3"
              }`}
            ></span>
          </button>
        </div>
