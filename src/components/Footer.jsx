        ...
        <div className="text-center pt-10 grid gap-1">
            ...
            <div className="icons flex gap-3 items-center justify-center">
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M17.5078 6.5H17.4988" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            </div>
            
        </div>
        <h6 className="capitalize font-patino text-primary underline pb-3 text-lg">built by: alexander preye</h6>
    </div>
  )
}
